    ...
    <Layout>
      ...
      <div className="body-wrapper">
          ...
          <div className="grid-300 mb-2">
            ...
            <div className="card">
              <Link to="/ducted-systems">
                ...
                <div className="card-body--">
                  <p className="card-text lead">
                    Cool or heat your entire home, with Ducted air conditioners.
                  </p>
                </div>
                <div className="text-blue text-shadow-2 mt-2">
                  Learn more >>
          ...
          <div className="grid-2">
            <div className="span-col-3">
              ...
              <p className="mt-20 lead">
                Are you finding the heat a little to hot to handle? Do you need
                a cooler solution? Well your in the right place! With our
                ...
                <a href="mailto:alvicair@hotmail.com"> email</a>, and even face
                to face with a free consultation to better understand your
                needs. We've got years of experience, talk to us to find out
                more about all the options, and we can provide a cost comparison
                to help you determine the best way to go. <br />
        ...
        <section className="section-3">
          ...
          <div>
            <p className="lead">
              We've been installing air conditioners for over a decade for most
              of the major builders, from Brisbane, Gold Coast and Tweed Heads
              area's. Specialising in high wall split, and multi head system
              with major brands like Haier, Kelvinator, Acrton, Daikin, Braemar,
              LG, Mitsubishi and Samsung as well as ducted residential and
              commercial systems with Daikin and Actron.
            </p>
            ...
            <p className="mt-20 lead">
              ...
              <a href="tel:0404602657"> 0404 602 657</a> we'll guarantee to beat
              any written quote. Stop paying too much for your air conditioning,
              and contact Home Comfort Air for the best and fair price in air
              conditioning installations for your home or space.
            </p>
          </div>
        </section>
