  ...
  return (
    <Layout>
      <SEO
        ...
        description={`Find out how Home Comfort Air has been installing new residential split system air conditioners throughout Ipswich, Brisbane and the Gold Coast area's.`}
        keywords={[
