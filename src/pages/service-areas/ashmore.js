  ...
  return (
    <Layout>
      <SEO
        ...
        description={`New supply and installation Haier air conditioning from $1199, We install all major brands of air conditioning units. Ashmore air con services.`}
        keywords={[
