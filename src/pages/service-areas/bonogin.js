  ...
  return (
    <Layout>
      <SEO
        ...
        description={`Supply and install Daikin air conditioning starting at $1,399. We service all major brands of air conditioning units. Bonogin air conditioning home cooling`}
        keywords={[
          `Bonogin,Gold,Coast,Air,Conditioning,
Split systems,install,Daikin,service`,
        ]}
      />
