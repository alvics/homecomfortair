  ...
  return (
    <Layout>
      <SEO
        ...
        description={`Replacement ac, with new bedroom split system air conditioning from $1099. Best and affordable ac service in Beenleigh. Hisense from $1199`}
        keywords={[
          `Beenleigh,Gold,Coast,Air,Conditioning,
Split systems,best,Hisense,ac`,
        ]}
      />
