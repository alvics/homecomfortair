...
const ServiceArea = () => {
  return (
    <Layout>
      <SEO
        title="Elanora Air Conditioning | Gold Coast Split System Air Conditioning"
        description={`Supply and install new bedroom split system air conditioning from $1099, We install all major brands of air conditioning units. Elanora air conditioning`}
        keywords={[
          `Elanora,Gold,Coast,Air,Conditioning,
Split systems,Ipswich,Brisbane,Specials`,
      ...
      <div className="container  body-wrapper">
        <div className="contact pt-2" style={{ textAlign: "center" }}>
          ...
          />
          <h1 className="p-3 text-dark cap fw-600 h4">Elanora Air Conditioning</h1>
        ...
        <article>   
             <div className="mt-3">
              <h2 className="h5 cap fw-600">Air Conditioning Elanora </h2>
             </div>
        ...
        <article>
            <h2 className="h5 cap fw-600">About Elanora</h2>
        
            <p className="lead-20">
             Elanora is a suburb located on the Gold Coast in Queensland, Australia. Known for its beautiful beaches, parks, and natural surroundings, Elanora is a popular place to live and visit.
            </p>

            <p className="lead-20">
             One of the things that sets Elanora apart from other suburbs on the Gold Coast is its beautiful natural surroundings. The suburb is home to a number of parks and reserves, including the Elanora Wetlands and the Currumbin Creek, which offer a variety of recreational activities such as hiking, picnicking, and birdwatching. The suburb is also home to a number of sporting facilities, including the Elanora Country Club and the Elanora State School, which offer a range of programs and classes for people of all ages and skill levels.
            </p>

            <p className="lead-20">
             In addition to its natural beauty, Elanora is home to a number of well-regarded schools, healthcare facilities, and other amenities. The suburb is known for its growing community and well-maintained homes, making it a popular choice for families and professionals looking for a peaceful and safe place to live.
            </p>

            <p className="lead-20">
             Despite its peaceful atmosphere, Elanora is by no means a quiet or boring suburb. The suburb is home to a number of restaurants, cafes, and bars, as well as several sporting facilities, including the Elanora Country Club and the Elanora State School. These facilities offer a range of programs and classes for people of all ages and skill levels, ensuring that there is always something to do in Elanora.
            </p>

            <p className="lead-20">
             If you're considering visiting or moving to Elanora, you'll be pleased to know that the suburb is easy to get to. Located just a short drive from the city center, Elanora is easily accessible by car, bus, or train. With its beautiful natural surroundings, growing community, and easy access to amenities and attractions, Elanora is a great place to call home.
            </p>
        </article>
