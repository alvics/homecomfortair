  ...
  return (
    <Layout>
      <SEO
        ...
        description={`Our entry-level split system air conditioning from $1099, We install all major brands of air conditioning units. Arundel air conditioning.`}
        keywords={[
          `Arundel,Gold,Coast,Air,Conditioning,
Split systems,installers,ac service`,
        ]}
      />
